...
BEGIN
    ...
    EXEC @LLMRetval = sp_invoke_external_rest_endpoint
         @url = 'https://ai-ready-apps02.openai.azure.com/.openai.azure.com/openai/deployments/gpt-4.1/chat/completions?api-version=2025-01-01-preview',
         @method = 'POST',
         @credential = [https://ai-ready-apps02.openai.azure.com/.openai.azure.com/],
         @payload = @LLMPayload,
